...
export const strings: Record<Locale, Strings> = {
  en: {
    ...
    hero: {
      ...
      line1: 'VIBE CODED.',
      line2: 'VIBE HARDENED.',
      copy: 'One command. No config. Scans code AND agent skill files generated by Cursor, Claude Code, OpenClaw, Hermes, v0, Lovable, Bolt — knows what each tends to get wrong.',
      execLabel: 'EXECUTE',
      execReady: '▶ READY',
    ...
    footer: {
      ...
      colSourceItems: [
        ...
        { label: 'Releases ↗', href: 'https://github.com/vibe-hardening/cli/releases' },
  ...
  zh: {
    ...
    hero: {
      ...
      line1: 'VIBE CODED.',
      line2: 'VIBE HARDENED.',
      copy: '一個指令、零設定。掃 Cursor、Claude Code、OpenClaw、Hermes、v0、Lovable、Bolt 寫的 code 跟 agent skill 檔案——知道每個工具各自最常漏掉什麼。',
      execLabel: '執行',
      execReady: '▶ READY',
      cmd: 'npx vibe-hardening scan',
    ...
    footer: {
      ...
      colSourceItems: [
        { label: 'GitHub ↗', href: 'https://github.com/vibe-hardening/cli' },
        { label: 'npm ↗', href: 'https://www.npmjs.com/package/vibe-hardening' },
        { label: '版本紀錄 ↗', href: 'https://github.com/vibe-hardening/cli/releases' },
        { label: 'Marketplace ↗', href: 'https://github.com/marketplace/actions/vibe-hardening' },
