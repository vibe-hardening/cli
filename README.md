...
40+ rules across 8 categories, tuned for repos generated by **v0 / Lovable / Bolt / Cursor / Claude Code / Replit Agent / Windsurf / Devin**.
...
Current coverage (`v0.0.5-preview.0`):
- Languages: JavaScript / TypeScript / Python (Django, Flask, FastAPI)
- 6 engines: RLS diff · JWT payload · auth AST · pattern-regex · OSV.dev · LLM hallucination
- 40+ rules · 162 tests · scans typical repo in under 5 seconds
